...
class PlaystorePurchaseWidget extends StatefulWidget {
  PlaystorePurchaseWidget({
    super.key,
  });

  @override
  State<PlaystorePurchaseWidget> createState() =>
      _PlaystorePurchaseWidgetState();
}

class _PlaystorePurchaseWidgetState extends State<PlaystorePurchaseWidget> {
  ...
  void _initializeInAppPurchase() {
    print('Initializing In-App Purchase for Play Store...');
